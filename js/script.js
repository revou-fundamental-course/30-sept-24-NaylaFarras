...
function resetForm() {
  ...
  document.getElementById('output-suhu').value = '';
  document.getElementById('kalkulasi').value = '';
  // Mengembalikan dropdown jenis konversi ke pilihan default (Celsius ke Fahrenheit)
  document.getElementById('jenis-konversi').value = 'celsius-to-fahrenheit';
  // Mengosongkan hasil deskripsi rumus dan rumus yang ditampilkan
  document.getElementById('descRumus').innerHTML = '';
